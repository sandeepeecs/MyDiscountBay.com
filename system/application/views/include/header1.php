...
document.searchform.s.value ="";
	...
	<title>Price Comparision site India</title>
<script type="text/javascript">
...
<body>
	<div  id="content">
        ...
        <h1 style="padding: 0 0 2px 310px;font-style: normal;font-size: 3.5em;font-style: normal;color: #686868;">MyDiscountBay</h1><sup>beta</sup>
        </div>
